...
urlpatterns = [
    ...
    path(r'^docs/', include_docs_urls(title='Phoenix API title', public=False)),
    path('backend/restaurants/', include('app.restaurants.urls')),
    path('backend/users/', include('app.users.urls')),
